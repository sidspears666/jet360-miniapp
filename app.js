(() => {
  ...
  function renderDetail(o) {
    ...
    if (idx > 0 && status !== "cancelled") btns.push('<button class="btn subtle-back" data-detail-action="ui-back"><span class="back-arrow" aria-hidden="true">&larr;</span> Geri</button>');
